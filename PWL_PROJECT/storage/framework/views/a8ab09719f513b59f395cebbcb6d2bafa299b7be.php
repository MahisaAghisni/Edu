            ...
            <div class="card-body">
                <form action="/admin/arena/<?php echo e($arena->id); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" value="<?php echo e($arena->nama); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="image" value="<?php echo e($arena->image); ?>">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PWL smt 4\PWL_PROJECT\resources\views/admin/arenas/edit.blade.php ENDPATH**/ ?>