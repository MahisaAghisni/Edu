                                        ...
                                        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo e(route('transaksi.success', $transaction->id)); ?>"
                                                        class="btn btn-outline-primary">
                                                        Selesai
                                                    </a>
                                                    <a href="<?php echo e(route('transaksi.batal', $transaction->id)); ?>"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PWL smt 4\PWL_PROJECT\resources\views/admin/transaksi/booking.blade.php ENDPATH**/ ?>